  ...
  return (
    <>
      <div className="flex min-h-screen">
        {/* Sidebar for xl+ */}
        <aside className="hidden xl:flex w-64 flex-col border-r border-gray-200 p-4">
          <svg
          ...
          <nav className="space-y-4">
            ...
            <div className="flex items-center gap-3 hover:bg-gray-100 p-2 rounded cursor-pointer">
              <Clapperboard size={24} /> <span>Reels</span>
            </div>
            <div className="flex items-center gap-3 hover:bg-gray-100 p-2 rounded cursor-pointer">
              <Heart size={24} /> <span>Notifications</span>
            </div>
            <div className="flex items-center gap-3 hover:bg-gray-100 p-2 rounded cursor-pointer">
              <Send size={24} /> <span>Messages</span>
            </div>
            <div className="flex items-center gap-3 hover:bg-gray-100 p-2 rounded cursor-pointer">
        ...
        <div className="flex-1 flex flex-col relative">
          {/* Mobile Header */}
          <header className="xl:hidden fixed top-0 left-0 right-0 bg-white border-b border-gray-200 z-10 flex items-center justify-between px-4 h-14">
            ...
            <input
              type="text"
              placeholder="Search"
              className="bg-gray-100 text-sm px-3 py-1 rounded-md w-1/2 outline-none"
            />
            <Heart size={24} />
          </header>

          {/* Scrollable Main Content */}
          <main className="flex-1 overflow-y-auto px-4 pt-16 pb-16 xl:pt-4 xl:pb-4">
            <h3>hello content</h3>
          </main>

          {/* Mobile Bottom Navbar */}
          <nav className="xl:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 h-14 flex items-center justify-around z-10">
            <Home size={24} />
            <Search size={24} />
